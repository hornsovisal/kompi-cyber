...
class CertificateService {
  constructor() {
    this.certificatePath = path.join(__dirname, "../certificates");
  ...
  generateCertificate(data) {
    ...
    doc.fontSize(16).fillColor("#FF6B35").text("~ OF ACHIEVEMENT ~", 60, 135, {
      align: "center",
      width: 475,
    });
    ...
    doc.rect(70, 460, 455, 120).lineWidth(1).strokeColor("#004B9D").stroke();
    ...
    doc
      ...
      .font("Helvetica")
      .fillColor("#111111")
      .text(`${Math.round(data.stats?.averageScore || 0)}%`, 80, detailsY + 70);
  ...
  getPublicPath(certificateCode) {
    return `/certificates/cert-${certificateCode}.pdf`;
  }
