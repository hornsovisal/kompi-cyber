...
import { Users, Mail, Plus, Search, CheckCircle2, AlertCircle, X, BookOpen } from "lucide-react";
import { fetchAllCourses, fetchCourseStudents, inviteStudent } from "../../services/rbacService";
...
export default function StudentManagement() {
  ...
  const handleInvite = async (e) => {
    ...
    try {
      ...
      setEmail(""); setName("");
      setShowInvite(false);
      showToast("success", `Student invited to "${selectedCourse.title}"!`);
    } catch (err) {
