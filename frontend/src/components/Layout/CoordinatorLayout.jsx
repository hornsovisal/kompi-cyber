...
export default function CoordinatorLayout({ children }) {
  ...
  useEffect(() => {
    ...
    if (!token || !instructor) {
      ...
      if (instructorData.roleId !== 4) {
        // Not coordinator, redirect to appropriate portal
        const redirectMap = {
  ...
  const navItems = [
    ...
    { label: "Courses", icon: BookOpen, path: "/coordinator/courses" },
    ...
    <div className="flex h-screen bg-slate-50">
      ...
      >
        <div className="p-6">
          ...
          <p className="text-slate-400 text-xs mt-1">Coordinator Portal</p>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-slate-700 text-sm">Coordinator Dashboard</div>
        </div>
