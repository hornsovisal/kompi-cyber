...
export class ResponsiveUtils {
   ...
   */
  static getPadding(small = 'px-4 py-4', medium = 'px-6 py-6 sm:px-8 sm:py-8', large = 'px-8 py-8 md:px-12 md:py-12') {
   ...
   */
  static getDisplay(mobile = 'block', tablet = 'md:hidden', desktop = 'lg:block') {
...
export class MobileFirst {
  ...
  static responsiveColumns(mobile = 'grid-cols-1', tablet = 'sm:grid-cols-2', desktop = 'lg:grid-cols-3') {
    return `grid ${mobile} ${tablet} ${desktop}`;
  }

  static responsiveText(mobile = 'text-base', tablet = 'sm:text-lg', desktop = 'lg:text-xl') {
    return `${mobile} ${tablet} ${desktop}`;
  }
}
